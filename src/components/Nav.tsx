...
const Nav:React.FC<IntroProps> = ({darkmode}) => {
  ...
  return (
    <div className={`${darkmode?'bg-blue-950/60 text-white':''} bg-white/60 w-full h-16 mx-auto mt-5 rounded-full sm:w-50 md:w-75 lg:w-1/2 sticky top-5 z-10 backdrop-blur-md`}>
